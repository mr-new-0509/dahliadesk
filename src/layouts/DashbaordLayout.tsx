...
import { Avatar, Box, Button, Divider, Drawer, Fab, Grid, List, ListItem, ListItemButton, ListItemIcon, ListItemText, Stack, Typography } from "@mui/material"
    ...
    <Box display="flex">
      <Drawer
        ...
        sx={{
          width: '17%',
          flexShrink: 0,
          '& .MuiDrawer-paper': { width: '17%', bgcolor: '#4fa7ef' }
        }}
      >
        <Box>
